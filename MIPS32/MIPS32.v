module MIPS32_pipe(clk1, clk2);
    ...
    //type refers to the type of instruction that we are working with
    ...
    if(HALTED == 0)
    begin
        if(((EX_MEM_IR[31:26]== BEQZ) && (cond == 1)) ||
        ((EX_MEM_IR[31:26]==BNEQZ) && (cond==0)))
            begin
